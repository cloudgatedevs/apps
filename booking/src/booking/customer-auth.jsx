import { ProfilePictureEditor, useSelfProfile } from './profile';
...
export function CustomerProvider({ children }) {
  ...
  const identityProfile = useSelfProfile(ready && !!session?.user);
  useEffect(() => {
    let active = true;
  ...
  return <CustomerContext.Provider value={{ ready, user: session?.user, identityProfile, canManage: preview || hasBackOfficeAccess(session?.user), profile, setProfile, signIn, signOut }}>{children}</CustomerContext.Provider>;
}

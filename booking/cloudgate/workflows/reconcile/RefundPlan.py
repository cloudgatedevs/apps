...
b=obj('RefundPrepare');p=obj('WalletRefund',{})
sql,result=plan(snapshot('AfterRefund'),dict(op='refund-apply',reference=b['reference'],provider=p,request_key=b['refund_key']),internal=True)
return sql
...
b=obj('Prepare');p=obj('WalletRefund',{})
sql,result=plan(snapshot('AfterWallet'),dict(op='refund-apply',reference=b['reference'],provider=p,request_key=b['refund_key']),internal=True)
return sql
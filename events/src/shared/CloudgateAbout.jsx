    ...
    <div className="cg-about">
      ...
      <section className="cg-about-card">
        ...
        <ul className="cg-about-facts">
          <li><Boxes size={15} /><span><strong>Workflows.</strong> Every operation — event discovery, bookings, admission and refunds — is a published workflow action under this app's controller. The Logs page shows each call.</span></li>
          ...
          <li><Mail size={15} /><span><strong>Email.</strong> Customer emails go out through Cloudgate delivery by default, or your own SMTP server when enabled under Email delivery.</span></li>

...
import { Store, Receipt as ReceiptIcon, Coins, Monitor, Mail, Palette, Trash2 } from 'lucide-react';
...
const TABS = [
  ...
  { key: 'email', label: 'Email', icon: Mail, hint: 'Cloudgate delivery with optional custom SMTP.', fields: [] },

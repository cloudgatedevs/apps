...
const key = 'courses.branding:' + (preview ? 'local-preview' : (import.meta.env.VITE_CLOUDGATE_API_URL || '') + ':' + (import.meta.env.VITE_CLOUDGATE_API_PROJECT || 'courses') + ':' + (import.meta.env.VITE_CLOUDGATE_API_ENV || 'sbx'));
let current = null;

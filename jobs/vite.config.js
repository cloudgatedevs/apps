...
export default defineConfig({plugins:[react(),fallback()],resolve:{alias:{'@':fileURLToPath(new URL('./src',import.meta.url))}},build:{rollupOptions:{input:{jobs:'index.html',admin:'admin.html'}}},server:{host:'127.0.0.1',port:3010,strictPort:true,proxy:{'/api':'http://127.0.0.1:3011'}}});
